...
function msToTime(duration) {
  var milliseconds = parseInt((duration % 10000) / 100),
    seconds = Math.floor((duration / 10000) % 60),
    minutes = Math.floor((duration / (10000 * 60)) % 60),
    hours = Math.floor((duration / (10000 * 60 * 60)) % 24),
    weeks = Math.floor((duration / (10000 * 60 * 60 * 24)) % 168)
